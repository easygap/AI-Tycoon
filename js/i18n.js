...
const DICT = {
    ko: {
        ...
        "settings.tagsEmpty": "아직 #태그가 적힌 메모가 없습니다. 디테일 패널 메모에 #frontend 같이 적어 보세요.",
        ...
        "welcome.desc": "내 컴퓨터에서 동작 중인 AI 에이전트들의 작업 상태를 픽셀 아트 오피스로 한눈에 확인해 보세요.",
        ...
        // 디테일 패널 (panel.js updateDetailPanel)
        ...
        "detail.detectionBasis": "인식 근거",
        "detail.recentSignals": "최근 신호",
        "detail.lastWord": "최근",
        "detail.statusUpdate": "상태 갱신",
        ...
        "card.stuckTitle": "5분 이상 활동 신호 없음 — 멈춘 것 같아요",
        "card.stuckChip": "멈춤?",
        ...
        "priority.tracking": "추적 중",
        "priority.selected": "선택됨",
        "priority.stale": "신호 확인",
        "priority.pinned": "고정 관찰",
        "priority.working": "진행 확인",
        "priority.recent": "최근 활동",
        "priority.idle": "대기",
        "priority.offline": "오프라인",
        ...
        "palette.actionCinema": "시네마 모드 (오버레이 숨김)",
        "palette.actionCompactCards": "에이전트 카드 컴팩트 보기 토글",
        "palette.actionInsights": "인사이트 모달 열기",
        ...
        "shortcuts.noteSaveClose": "저장 + 디테일 패널 닫기",
        ...
        "shortcuts.noteFocus": "선택된 에이전트의 메모로 포커스",
